...
这是一本了解`编程底层`的高级入门书（本书并非定位于PHP语言学习者，也可帮助一切Web编程语言的从业者进入底层计算机原理和C语言的世界）。看完这本书，别再告诉我你学不会C语言了。没错，这本书专治顽疾，各种学不会C语言的顽疾。为此，我已请出八大天神为你加油！
...
- `第八部` 摩呼罗迦，逍遥
  ...
  [第23章 编译原理](md/fundamentalsofcompiling/readme.md)
